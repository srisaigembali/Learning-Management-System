...
const StudentCourseProgressPage = () => {
	...
	useEffect(() => {
		if (currentLecture?.progressVlaue === 1) updateCourseProgress();
	}, [currentLecture]);
	...
	return (
		<div className='flex flex-col h-screen bg-[#1c1d1f] text-white'>
			...
			<div className='flex items-center justify-between p-3 bg-[#1c1d1f] border-b border-gray-700'>
				<div className='flex items-center space-x-4'>
					...
					>
						...
						<div className='pr-1 pb-0.5'>Back to My Courses Page</div>
					</Button>
